        ...
        <div>
            {dataTemp && dataTemp.main && Array.isArray(dataTemp.weather) && dataTemp.weather.length > 0 && (
                <div>
                    ...
                    <div>کمترین دما:{convertTempToCelsiuos(dataTemp.main.temp_min)}</div>
                    <div>بیشترین دما:{convertTempToCelsiuos(dataTemp.main.temp_max)}</div>
                    <div>دمای احساس شده:{convertTempToCelsiuos(dataTemp.main.feels_like)}</div>
