    ...
    return (
        <div>
            {dataTemp && dataTemp.main && Array.isArray(dataTemp.weather) && dataTemp.weather.length > 0 && (
                <div>
                    <div>دمای هوا:{(dataTemp.main.temp)}°C</div>
                    <div>کمترین دما:{(dataTemp.main.temp_min)}°C</div>
                    <div>بیشترین دما:{(dataTemp.main.temp_max)}°C</div>
                    <div>دمای احساس شده:{(dataTemp.main.feels_like)}°C</div>
