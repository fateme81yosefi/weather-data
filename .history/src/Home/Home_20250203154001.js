...
import './Home.css'
import location from '../../public/location-pin-svgrepo-com.svg'
const Home = () => {
            ...
            {dataTemp && dataTemp.main && Array.isArray(dataTemp.weather) && dataTemp.weather.length > 0 && (
                <div className="contain-weather-info">
                    ...
                    <div className="location">
                        <div>{dataLocation.city},{dataLocation.country}</div>            <img src="/location-pin-svgrepo-com.svg" alt="Location Icon" />
