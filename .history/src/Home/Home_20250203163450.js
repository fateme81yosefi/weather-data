...
const Home = () => {
    ...
    const getWeatherImage = (condition) => {
            ...
            switch (condition) {
                case 'clear':
                    return ''; // لینک به تصویر برای هوای صاف
                case 'clouds':
                    return ''; // لینک به تصویر برای هوای ابری
                case 'rain':
                    return ''; // لینک به تصویر برای هوای بارانی
                case 'snow':
                    return ''; // لینک به تصویر برای هوای برفی
                case 'thunderstorm':
                    return ''; // لینک به تصویر برای طوفان
                default:
                    return ''; // تصویر پیشفرض
            }
        }
