                ...
                <div className="contain-weather-info">
                    ...
                    <div className="contain-detail">
                        ...
                        <div className="contain-temp-main">
                            ...
                            <div className="data-weather">کمترین دما:<span>°C{Math.round(dataTemp.main.temp_min)}</span></div>
                            <div className="data-weather">بیشترین دما:<span>{Math.round(dataTemp.main.temp_max)}°C</span></div>
                            <div className="data-weather">دمای احساس شده:<span>{Math.round(dataTemp.main.feels_like)}°C</span></div>
