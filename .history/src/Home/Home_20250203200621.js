...
const Home = () => {
    ...
    const handleTomorrowClick = () => {
        ...
        today.setDate(today.getDate() + 1); // اضافه کردن یک روز به تاریخ امروز
        const tomorrow = today.toISOString().split('T')[0]; // تاریخ فردا را به فرمت YYYY-MM-DD بگیر
        setSelectedDate(tomorrow); // ذخیره تاریخ فردا در state
      };
